    ...
    return (
        <Card
            ...
            <Text
                ...
                alignItems={"center"}
                color={theme.colors.white}>
                Powered by <Image alignItems={"center"} mx={"5px"} width={"20px"} height={"15px"} src={"https://dumbways.id/assets/images/brandred.png"}></Image> DumbwaysIndonesia  <Box as={FaCircle} fontSize={"7.5px"} mx={"5px"} />  #1 Coding Bootcamp
            </Text>
